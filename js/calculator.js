...
const Calculator = {
    ...
    //This will hold the operator, we set it to null fo rnow.
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //Here we add a fixed amount of numbers after the decimal point.
...
function Update_Display() {
    //Makes use of the caluclator-screen class to target the
